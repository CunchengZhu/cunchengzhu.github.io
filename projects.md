...
## Fluid membrane
<p align="center">
  <img src="/assets/images/fluidMembrane/soap.png" alt="soap bubble" width="200">
  <img src="/assets/images/fluidMembrane/surfactant.png" alt="surfactant" width="200">
</p>
When we talk about isotropic fluid membranes, the classic example that comes to mind is a soap bubble. 
Microscopically, it consists of a thin layer of water enclosed by two layers of surfactant molecules. Both the water and surfactant molecules are free to move tangentially, meaning the membrane behaves as a two-dimensional isotropic fluid. However, due to the lack of internal structure, the only stress it can support is tangential, known as **surface tension**.

<p align="center">
  <img src="/assets/images/fluidMembrane/lipid.png" alt="lipid" width="200">
  <img src="/assets/images/fluidMembrane/helfrich.png" alt="helfrich" width="200">
</p>
...
Mathematically, the Canham–Helfrich energy is particularly elegant, depending only on two geometric invariants of the surface: the mean curvature $H$ and the Gaussian curvature $$K$$. Independently, this same energy arises in differential geometry under the name Willmore energy. The Willmore conjecture, concerning the minimal Willmore energy configuration for tori, remained open for decades before being resolved in the early 2010s.

<p align="center">
  <img src="/assets/images/fluidMembrane/RBC.png" alt="RBC" width="200">
</p>
...
This brings us to a more physically grounded alternative. The realistic dynamics of fluid membranes arise from the viscous limit of the Navier–Stokes equations. This leads to [evolving Stokes flow](https://doi.org/10.1017/jfm.2024.1208), a natural gradient flow governed by the viscous dissipation metric and subject to volume-preserving (i.e., incompressibility) constraints.

<p align="center">
    <img src="/assets/images/publications/evolve.jpeg" alt="Evolving Stokes flow" width="200">
</p>